...
#
########################################################################
# Further changes for multimv vendoring:
#  Based on: https://gitlab.com/ericvsmith/toposort/-/blob/master/toposort.py
#  Changed the output line slightly
#  Deepcopy the input to actually leave it unmodified
...
"""
    ...
    while True:
        ...
        if not ordered:
            break
        # NOTE: changed this line so non-depends don't get emitted
        # yield ordered
        yield ordered - extra_items_in_deps
